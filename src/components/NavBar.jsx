          ...
          <div className="col2 w-[65%]">
            <ul className="flex items-center gap-8 nav">
              ...
              <li className="list-none relative">
                <Link to={"/medicine"} className="link transition text-[14px] font-[500]">
                  <Button className="link transition !font-[500] !text-[rgba(0, 0, 0, 0.8)] hover:!text-[#287c2c]">
                    Medicine
                  </Button>
                </Link>
                <div className="submenu absolute top-[100%] left-[0%] min-w-[150px] bg-white shadow-md opacity-0 transition-all">
                  <li className="list-none w-full">
                    <Link to={"/dairy"} className="w-full">
              ...
              <li className="list-none relative">
                <Link to={"/grocery"} className="link transition text-[14px] font-[500]">
                  <Button className="link transition !font-[500] !text-[rgba(0, 0, 0, 0.8)] hover:!text-[#287c2c]">
                    Grocery
                  </Button>
                </Link>
              ...
              <li className="list-none relative">
                <Link to={"/electronics"} className="link transition text-[14px] font-[500]">
                  <Button className="link transition !font-[500] !text-[rgba(0, 0, 0, 0.8)] hover:!text-[#287c2c]">
                    Electronics
                  </Button>
                </Link>
              ...
              <li className="list-none relative">
                <Link to={"/fashion"} className="link transition text-[14px] font-[500]">
                  <Button className="link transition !font-[500] !text-[rgba(0, 0, 0, 0.8)] hover:!text-[#287c2c]">
                    Fashion
                  </Button>
                </Link>
              ...
              <li className="list-none relative">
                <Link to={"/beauty"} className="link transition text-[14px] font-[500]">
                  <Button className="link transition !font-[500] !text-[rgba(0, 0, 0, 0.8)] hover:!text-[#287c2c]">
                    Beauty
                  </Button>
                </Link>
              ...
              <li className="list-none relative">
                <Link to={"/wellness"} className="link transition text-[14px] font-[500]">
                  <Button className="link transition !font-[500] !text-[rgba(0, 0, 0, 0.8)] hover:!text-[#287c2c]">
                    Wellness
                  </Button>
                </Link>
              ...
              <li className="list-none relative">
                <Link to={"/jewellery"} className="link transition text-[14px] font-[500]">
                  <Button className="link transition !font-[500] !text-[rgba(0, 0, 0, 0.8)] hover:!text-[#287c2c]">
                    Jewellery
                  </Button>
                </Link>
